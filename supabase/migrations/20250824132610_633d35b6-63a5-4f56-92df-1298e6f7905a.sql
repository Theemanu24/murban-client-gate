-- Set all client passwords to first name in lowercase + @2025
UPDATE public.clients SET password_hash = extensions.crypt('swahili@2025', extensions.gen_salt('bf', 12)) WHERE slug = 'swahili-beach';
