...
export const PasswordGate = ({ clientSlug, terminal, onSuccess }: PasswordGateProps) => {
  ...
  return (
    <div className="max-w-md w-full mx-auto">
      <div className="w-full bg-gradient-to-br from-slate-900/98 via-slate-800/98 to-slate-900/98 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-6 hover:shadow-white/10 hover:border-white/30 transition-all duration-300">
