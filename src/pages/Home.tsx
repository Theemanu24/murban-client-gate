        ...
        <div className="relative z-20 text-center px-4 sm:px-6 flex flex-col py-8">
          <div className="max-w-4xl mx-auto flex flex-col justify-center">
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-white tracking-tight relative" style={{ lineHeight: '1.3', paddingBottom: '0.25em' }}>
                {titleWords.map((word, index) => (
                  <motion.span
                    ...
                    className={
                      "inline-block mr-4 md:mr-6 relative cinematic-text overflow-visible font-semibold tracking-wider text-white"
                    }
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-lg sm:text-xl md:text-2xl font-medium text-white mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed py-1 tracking-wide"
            >
