      ...
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 flex flex-col py-8">
          <div className="max-w-4xl mx-auto flex flex-col justify-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold text-[#FFD700] tracking-tight relative" style={{ lineHeight: '1.3', paddingBottom: '0.25em' }}>
            ...
            <motion.p
              ...
              initial="hidden"
              animate="visible"
              className="text-lg sm:text-xl md:text-2xl font-bold text-[#FFD700] mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed py-1"
            >
